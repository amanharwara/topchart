  ...
  return (
    <div class="relative flex">
      <button
        ...
        class={classNames(
          "peer flex items-center gap-2 rounded border border-slate-600 p-1.5 hover:bg-slate-600",
          props.className
        )}
        {...otherProps}
      >
      ...
      <div
        role="tooltip"
        class={classNames(
          "absolute left-auto right-0 w-max rounded bg-slate-900 py-2 px-3 text-sm text-white",
